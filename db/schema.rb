...
ActiveRecord::Schema[7.0].define(version: 2023_03_09_030732) do
  ...
  create_table "apartment_amenities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "building_policies", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
